...
const Invoiceupload = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setStatus("Uploading...");
       ...
       await axios.post(
        "http://localhost:3000/api/v1/admin/invoice", 
        formData,
        {
          headers: {
  ...
  return (
    <div className="flex flex-col items-center mt-5 min-h-screen bg-gray-50 p-6">
      ...
      <button onClick={handleViewCampaign} className=" border-2 hover:bg-gray-200 px-3 tracking-tighter py-2 rounded-lg font-bold fixed right-24 top-24">
        View invoice
        </button>
